...
# Helper to map alpha‐2 → alpha‐3 safely
...
def main():
    ...
    if nbr_codes:
        ...
        common_n=[COUNTRY_NAME_MAP[c] for c in gb if c in pivot_n.columns]
        if len(common_n)>=2:
            ...
            edges_n=[(i,j) for i in common_n for j in common_n
            ...
            fig_net_n.add_trace(go.Scatter(x=nx_n,y=ny_n,mode="markers+text",
